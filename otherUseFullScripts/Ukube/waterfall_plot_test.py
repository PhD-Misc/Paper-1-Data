...
waterfall = np.zeros((80,768))

hfont = {'fontname':'Helvetica', 'size':15}


for i in range(80):
	for file in glob.glob("25510-m1-" +str(i) + ".txt"):
...
plt.imshow(waterfall, cmap=cmap, interpolation='bilinear', aspect='auto', extent=[72.335, 103.015, 39, 0])
plt.colorbar()
#plt.colorbar()
