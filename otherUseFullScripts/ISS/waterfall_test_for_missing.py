...
line1 = "ISS"
line2 = "1 02802U 67045B   16078.57485238  .00000121  00000-0  42610-4 0  9999"
line3 = "2 02802  74.0109 294.7849 0065690  98.9580 261.9020 14.43565355563233"
...
for timeStep in range(90):
	...
	for f in range(768):
		...
		noise1 = fits.open('1142425368-2m-' +str(timeStep) +'-0664-image.fits' )
		noise2 = fits.open('1142425368-2m-' +str(timeStep+1) +'-0664-image.fits' )
		noise = noise2[0].data[0,0,:,:] - noise1[0].data[0,0,:,:]
		...
		UTCTime2 = datetime.strptime(header2['DATE-OBS'], '%Y-%m-%dT%H:%M:%S.%f') + timedelta(seconds=-12.9)
		...
		#	dataDiff = diff
		#else:
		#	dataDifftemp = diff + noise
		#	dataDiff = np.divide(dataDifftemp, 2)
		...
		np.savetxt("2802-" + str(timeStep) + ".txt", waterfall[timeStep,:])
