...
plt.imshow(waterfall, cmap=cmap, interpolation='nearest', aspect='auto', extent=[72.335, 103.015, 34, 0], vmax=9)

plt.xlim(85.1, 103.015)

#The below are perth transmitters
plt.vlines(92.1, colors='white', ymin=0, ymax=34, linestyles=":")
plt.vlines(92.9, color="white", ymin=0, ymax=34, linestyles=":")
#plt.vlines(93.7, colors='white', ymin=0, ymax=34,linestyles=':')
plt.vlines(94.5, colors='white', ymin=0, ymax=34,linestyles=':')
#plt.vlines(95.3, colors='white', ymin=0, ymax=49,linestyles=':')
plt.vlines(96.1, colors='white', ymin=0, ymax=34,linestyles=':')
plt.vlines(96.9, colors='white', ymin=0, ymax=34,linestyles=':')
plt.vlines(97.7, colors='white', ymin=0, ymax=34,linestyles=':')
#plt.vlines(98.5, colors='white', ymin=0, ymax=49,linestyles=':')
plt.vlines(99.3, colors='white', ymin=0, ymax=34,linestyles=':')
...
plt.annotate("RTR",xy=(92.2, 25),xycoords='data', rotation=90, color='white')
plt.annotate("PPM",xy=(93, 25),xycoords='data', rotation=90, color='white')
#plt.annotate("PER",xy=(93.8, 25),xycoords='data', rotation=90, color='white')
plt.annotate("MIX",xy=(94.6, 25),xycoords='data', rotation=90, color='white')
plt.annotate("NOW",xy=(96.2, 25),xycoords='data', rotation=90, color='white')
plt.annotate("SBSFM",xy=(97, 25),xycoords='data', rotation=90, color='white')
plt.annotate("ABCFM",xy=(97.8, 25),xycoords='data', rotation=90, color='white')
plt.annotate("JJJ",xy=(99.4, 25),xycoords='data', rotation=90, color='white')
#plt.annotate("NR",xy=(100.2, 25),xycoords='data', rotation=90, color='white')
#plt.annotate("NME",xy=(101, 25),xycoords='data', rotation=90, color='white')

#The below are the transmitters in geraldton
plt.vlines(94.9, colors='yellow', ymin=0, ymax=34,linestyles=':')
...
plt.vlines(101.3, colors='yellow', ymin=0, ymax=34,linestyles=':')
plt.annotate("ABCFM",xy=(95, 25),xycoords='data', rotation=90, color='yellow')
...
plt.annotate("PNN",xy=(101.4, 25),xycoords='data', rotation=90, color='yellow')



#plt.colorbar()
#plt.vlines(90.5, colors='orange', ymin=0, ymax=89,linestyles=':', label='test')
