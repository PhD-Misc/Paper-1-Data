...
line1 = "ALOUETTE"
line2 = "1 25288U 98021D   14348.33836956  .00000498  00000-0  17085-3 0  9993"
line3 = "2 25288 086.3976 246.6557 0002238 098.9060 039.2902 14.34225417873745"
...
for timeStep in range(90):
	...
	for f in range(768):
		...
		#UTCTime1 = datetime.strptime(header1['DATE-OBS'], '%Y-%m-%dT%H:%M:%S.%f') + timedelta(seconds=2.5)
		UTCTime2 = datetime.strptime(header2['DATE-OBS'], '%Y-%m-%dT%H:%M:%S.%f') + timedelta(seconds=2)
		...
		#print("At time step " + str(timeStep) + " the target was at a range of " + str(sat.range))
		...
		np.savetxt("25288-2-sum-" + str(timeStep) + ".txt", waterfall[timeStep,:])
