...
line1 = "DUCHIFAT"
line2 = "1 10062U 77048B   16078.85116275 +.00000401 +00000-0 +10700-3 0  9998"
line3 = "2 10062 028.4195 231.4342 0737229 229.2113 124.2164 13.36502601885771"
...
for timeStep in range(90):
	...
	for f in range(768):
		...
		UTCTime2 = datetime.strptime(header2['DATE-OBS'], '%Y-%m-%dT%H:%M:%S.%f') + timedelta(seconds=-0.5)
		...
		waterfall[timeStep, f] = snr/(2*(size_of_box**2))
		
		np.savetxt("10062-m0p5-" + str(timeStep) + ".txt", waterfall[timeStep,:])
